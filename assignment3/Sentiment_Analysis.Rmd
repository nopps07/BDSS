...
#### _**The sentiment of AI in academia has changed since the launch of ChatGPT**_
...
Even though that the authors of the papers are expected to be _influential_, we conclude that the total data size is not sufficient to obtain meaningful results. Therefore, we conduct one additional data collection in order to enlarge the inventory. 
...
# 4. Discussion
Here we summarize the findings and use them to answer the research questions.
